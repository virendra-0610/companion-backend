...
import { sendPushToToken, removeBadToken, writeNotificationHistory, safeHistoryKey } from "./push.js";
...
async function loadMostRecentActiveToken(db) {
  ...
  snap.forEach((doc) => {
    ...
    candidates.push({
      ...
      taskRemindersEnabled: true,
      sortTime:
        extractSortTime(data.lastSyncedAt) ||
        extractSortTime(data.updatedAt) ||
        extractSortTime(data.createdAt) ||
        0
    });
  });
